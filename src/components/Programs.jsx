      ...
      <div className="container">
        ...
        <div className="row mb-5 align-items-center">
          <div className="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
            <img src={require("assets/images/undraw_youtube_tutorial.svg")} alt="Image" className="img-fluid"/>
          </div>
        ...
        <div className="row mb-5 align-items-center">
          <div className="col-lg-7 mb-5 order-1 order-lg-2" data-aos="fade-up" data-aos-delay="100">
            <img src={require("assets/images/undraw_teaching.svg")} alt="Image" className="img-fluid"/>
          </div>
        ...
        <div className="row mb-5 align-items-center">
          <div className="col-lg-7 mb-5" data-aos="fade-up" data-aos-delay="100">
            <img src={require("assets/images/undraw_teacher.svg")} alt="Image" className="img-fluid"/>
          </div>
          <div className="col-lg-4 ml-auto" data-aos="fade-up" data-aos-delay="200">
