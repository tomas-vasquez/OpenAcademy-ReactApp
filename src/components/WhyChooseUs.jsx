    ...
    return (
      ...
      <div className="future-blobs">
        <div className="blob_2">
          <img src={require("assets/images/blob_2.svg")} />
        </div>
        <div className="blob_1">
          <img src={require("assets/images/blob_1.svg")} />
        </div>
      </div>
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-lg-7 align-self-end"  data-aos="fade-left" data-aos-delay="200">
            <img src={require("assets/images/person_transparent.png")}  alt="Image" className="img-fluid"/>
          </div>
        </div>
      </div>
    </div>
